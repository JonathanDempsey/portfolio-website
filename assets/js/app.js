...
$(document).ready(function () {
  ...
  $(document.body).on('DOMMouseScroll mousewheel', function (e) {
    ...
    if(div == 1) {
      ...
      $('.project--3__description').delay(1000).css({'height': 'auto', 'opacity':'1'});

      $('.project--4__title').removeClass('project-title__active');
      $('.project--4__subtitle').css({'margin-left': '-200px', 'opacity':'0'});
      $('.project--4__description').css({'height': '0', 'opacity':'0'});
    } else if(div == 4) {
      $('.project--3__title').removeClass('project-title__active');
      $('.project--3__subtitle').css({'margin-left': '-200px', 'opacity':'0'});
      $('.project--3__description').css({'height': '0', 'opacity':'0'});
      ...
      $('.project--4__description').delay(1000).css({'height': 'auto', 'opacity':'1'});

      $('.project--5__title').removeClass('project-title__active');
      $('.project--5__subtitle').css({'margin-left': '-200px', 'opacity':'0'});
      $('.project--5__description').css({'height': '0', 'opacity':'0'});
    } else if(div == 5) {
      $('.project--4__title').removeClass('project-title__active');
      $('.project--4__subtitle').css({'margin-left': '-200px', 'opacity':'0'});
      $('.project--4__description').css({'height': '0', 'opacity':'0'});
      ...
      $('.project--5__description').delay(1000).css({'height': 'auto', 'opacity':'1'});
    }
